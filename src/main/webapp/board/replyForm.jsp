...
<%
    ...
    System.out.println(ref +"," +re_step + ","+re_level+","+pageNum);
...
<body>
    <form style="border: 1px solid #ccc; width: 650px;  margin: 30 auto; padding: 40px; border-radius: 5px;" action="replyproc.jsp?pageNum=<%=pageNum%>" name="f" method="post">
    <div>
        <b>Q&A</b>
    </div><br><br>
        <div>

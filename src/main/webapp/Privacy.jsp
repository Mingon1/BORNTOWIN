...
<%@include file="top.jsp"%>
    ...
    <div style="padding:40px;"><h3>개인정보처리방침</h3></div>
    
    <div style="padding:40px; font-size: 13px; color: #666666;">
    
** 본 양식은 쇼핑몰 운영에 도움을 드리고자 샘플로 제공되는 서식으로 쇼핑몰 운영형태에 따른 수정이 필요합니다. 쇼핑몰에 적용하시기 전, 쇼핑몰 운영 사항 등을 확인하시고 적절한 내용을 반영하여 사용하시기 바랍니다. **
<br><br>
(주)본투윈은 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "개인정보 보호법" 등 관련 법령을 준수하고 있습니다.
...
회원이 탈퇴한 경우에도 불량회원의 부정한 이용의 재발을 방지, 분쟁해결 및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 3년간 회원의 정보를 보유할 수 있습니다.<br><br>
...
o 위탁 대상자 : 한진택배<br>
o 위탁업무 내용 : 주문 상품의 배송 및 반품 회수<br><br>

o 위탁 대상자 : 이니시스, 엔에이치엔, 카카오<br>
o 위탁업무 내용 : 카드결제, 간편결제, 계좌이체, 에스크로<br><br>

o 위탁 대상자 : 카페24<br>
o 위탁업무 내용 : 전산 시스템 구축 및 유지<br><br>

o 위탁 대상자 : 채널톡<br>
o 위탁업무 내용 : 고객상담센터 운영<br><br>
...
성명 : 정주현<br>
소속 : 경영지원팀<br>
전화번호 : 070-4242-4243<br>
이메일 : juhyeon.jeong@borntowin.co.kr<br>
<br><br>
o 개인정보보호책임자<br>
성명 : 한동수<br>
소속 : 패션사업부<br>
전화번호 : 010-4228-7767<br>
이메일 : dongsoo.han@borntowin.co.kr <br>
<br><br>

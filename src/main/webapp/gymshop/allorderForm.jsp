...
ArrayList<CartBean> clists2 = cdao.getAllCartListById(userid);
...
<div class="accordion" id="accordionPanelsStayOpenExample">
  ...
  <%-- <%System.out.println("올오더폼상품갯수"+totaloqty);%>
  <%System.out.println("올오더폼상품이름"+allPname);%> --%>
